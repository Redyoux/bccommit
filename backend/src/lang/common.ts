...
const strings = new LocalizedStrings({
  fr: {
    ...
    LONGITUDE: 'Longitude',
    LATITUDE: 'Latitude',
    USER_IDENTIFICATION: "Pièce d'identité",
    USER_DRIVING_LICENCE: 'Permis de conduire',
  ...
  en: {
    ...
    LONGITUDE: 'Longitude',
    LATITUDE: 'Latitude',
    USER_IDENTIFICATION: 'Identification Number',
    USER_DRIVING_LICENCE: 'Driving licence',

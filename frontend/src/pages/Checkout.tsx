...
const Checkout = () => {
  ...
  const [additionalDriverUserIdentification, setAdditionalDriverUserIdentification] = useState('')
  const [additionalDriverDrivingLicence, setAdditionalDriverDrivingLicence] = useState('')

  const [additionalDriverNationality, setAdditionalDriverNationality] = useState('')
  ...
  const handleUserIdentificationChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setUserIdentification(e.target.value)
  }    
  const handleUserDrivingLicenceChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleAdditionalDriverUserIdentificationChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setAdditionalDriverUserIdentification(e.target.value)
  }    
  const handleAdditionalDriverDrivingLicenceChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setAdditionalDriverDrivingLicence(e.target.value)
  }
  const handleAdditionalDriverNationalityChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setAdditionalDriverNationality(e.target.value)
  }
    ...
    try {
      ...
      if (adRequired && additionalDriver && addiontalDriverBirthDate) {
        _additionalDriver = {
          ...
          userIdentification: additionalDriverUserIdentification,
          userDrivingLicence: additionalDriverDrivingLicence,
          nationality: additionalDriverNationality,
        }
      }
                  ...
                  {!authenticated && (
                    <div className="driver-details">
                      ...
                      <div className="driver-details-form">
                        ...
                        <FormControl fullWidth margin="dense">
                          <InputLabel className="required">{commonStrings.USER_IDENTIFICATION}</InputLabel>
                          <OutlinedInput type="text" label={commonStrings.USER_IDENTIFICATION} required onChange={handleUserIdentificationChange} autoComplete="off" />
                        </FormControl>
                        

                        <FormControl fullWidth margin="dense">
                          <InputLabel className="required">{commonStrings.USER_DRIVING_LICENCE}</InputLabel>
                          <OutlinedInput type="text" label={commonStrings.USER_DRIVING_LICENCE} required onChange={handleUserDrivingLicenceChange} autoComplete="off" />
                        </FormControl>

                        <FormControl fullWidth margin="dense">
                          <InputLabel className="required">{commonStrings.NATIONALITY}</InputLabel>
                          <OutlinedInput type="text" label={commonStrings.NATIONALITY} required onChange={handleNationalityChange} autoComplete="off" />
                        </FormControl>

              ...
              <Box
                ...
                sx={{
                  ...
                  "&:hover": {
                    ...
                    boxShadow: `#ccaed1 0px 54px 55px, 
                 rgba(0, 0, 0, 0.12) 0px -12px 30px, 
                 #ccaed1 0px 4px 6px, 

                 #ccaed1 0px -3px 2px,
                 #ccaed1 0px 30px 60px -12px inset, 
              ...
              >
                <Box
                  sx={{
                    ...
                    "&:hover": {
                      boxShadow: "inset 10px 10px 50px 10px   #00g", // Change this to your desired hover color
                  ...
                  <div className="containerMain">
                    <div className="coll1">
                      ...
                      <div
                        className="car-info"
                        style={
                          hidePrice && !env.isMobile() ? { width: "65%" } : {}
                        }
                      >
                        <ul className="car-info-list">
                          ...
                          {car.mileage !== 0 && (
                            <li className="mileage">
                              <Tooltip
                                title={helper.getMileageTooltip(
                                  car.mileage,
                                  language
                                )}
                                placement="left"
                          ...
                          <li className="fuel-policy">
                            <Tooltip
                              title={helper.getFuelPolicyTooltip(
                                car.fuelPolicy
                              )}
                              placement="left"
                            >
                        ...
                        <div className="price">
                          <div className="card">
                            <div className="card-info">
                              ...
                              <div
                                className="card-subtitle price-day"
                                style={{ fontSize: "16px" }}
                              >
                                {`${

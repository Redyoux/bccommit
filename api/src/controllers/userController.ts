...
const _signup = async (req: Request, res: Response, userType: bookcarsTypes.UserType) => {
  ...
  try {
    ...
    body.type = userType
    body.userIdentification = body.userIdentification 
    body.userDrivingLicence = body.userDrivingLicence 
  ...
  try {
    ...
    if (passwordMatch) {
      ...
      const loggedUser: bookcarsTypes.User = {
        ...
        userDrivingLicence : user.userDrivingLicence,
      ...
      [
        ...
        },
        {
          $project: {
            ...
            birthDate: 1,
            customerId: 1,
            userIdentification: 1, // Add this line
            userDrivingLicence: 1, // Add this line
            nationality: 1, // Add this line
          },
        },
        {
          $facet: {
